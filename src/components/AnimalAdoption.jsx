    ...
    <div className="">
      ...
      <section class="relative bg-gray-100">
        <div class="relative">
          {/* <!-- Background Image --> */}
          <img
            src="https://img.freepik.com/premium-photo/person-holding-dog-with-paw-that-says-it_98005-3741.jpg?w=1380"
            alt="Pet Care"
      ...
      <section className="bg-gray-50 py-10 md:py-16">
        <div className="container mx-auto px-6 md:px-10 lg:px-20">
          <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2">
            ...
            <div>
              <img
                src="https://img.freepik.com/premium-photo/little-boy-looking-puppy-cage-animal-shelter-boys-hand-is-cage-puppy-is-looking-him-with-sad-eyes_14117-519643.jpg?w=1380"
